...
| `223027` | **odometer** ×0.1 km (u24) | `[B4:B6]/10` | 10 875.9 km | high — confirmed against the dash (Rob, 2026-08-22) |
...
| odometer | 223027, init `ATSHDA42F1;` | `[B4:B6]/10` | km | distance (total_increasing) — dash-confirmed |
